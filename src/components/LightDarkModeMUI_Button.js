...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {   // This is for before if shows the moon after click it shows the sun
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#8796A5' : '#ff6b81',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    ...
    width: 32,
    height: 32,
    '&:before': {            // This is for sun and moon image
      content: "''",
      position: 'absolute',
      width: '100%',
      height: '100%',
